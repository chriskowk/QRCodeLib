...
namespace ThoughtWorks.QRCode.Codec.Reader.Pattern
{
    ...
    public class FinderPattern
    {
        ...
        internal int[] _sincos;
        internal int[] _width;
        internal int[] _moduleSize;
        ...
        {
            return _moduleSize[UL];
        }
        public virtual int getModuleSize(int place)
        {
            return _moduleSize[place];
        }
        ...
        internal static Line[] findLineAcross(bool[][] image)
        {
            ...
            _canvas.drawLines(foundLines, ThoughtWorks.QRCode.Codec.Util.Color_Fields.LIGHTGREEN);
            return foundLines;
        }
        ...
        internal static int[] getAngle(Point[] centers)
        {
            ...
            _canvas.println("originPoint is: " + originPoint);
        ...
        internal static Point[] getCenter(Line[] crossLines)
        {
            ...
            {
                _canvas.drawPolygon(foundPoints, ThoughtWorks.QRCode.Codec.Util.Color_Fields.RED);
                return foundPoints;
            }
            else
        ...
        internal static int calcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
        {
            ...
            _canvas.drawPoints(points, ThoughtWorks.QRCode.Codec.Util.Color_Fields.RED);
            ...
            {
                _canvas.println("Version info error. now retry with other place one.");
