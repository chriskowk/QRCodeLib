...
namespace ThoughtWorks.QRCode.Codec.Data
{
    ...
    public class QRCodeSymbol
    {
        ...
        virtual public int NumRSBlocks
        {
            get
            {
                return _numRSBlocks[_version - 1][_errorCollectionLevel];
            }
        ...
        virtual public string VersionReference
        {
            get
            {
                ...
                return System.Convert.ToString(_version) + "-" + versionReferenceCharacter[_errorCollectionLevel];
            }
        ...
        {
            return _moduleMatrix[x][y];
        }

        public QRCodeSymbol(bool[][] moduleMatrix)
        {
            this._moduleMatrix = moduleMatrix;
            _width = moduleMatrix.Length;
            _height = moduleMatrix[0].Length;
            initialize();
        }
        ...
        internal virtual void initialize()
        {
            ...
            if (_version >= 2 && _version <= 40)
            {
                logicalSeeds = LogicalSeed.getSeed(_version);
            ...
            _dataCapacity = calcDataCapacity();
        ...
        private int calcDataCapacity()
        {
            ...
            int dataCapacity = (_width * _width - numFunctionPatternModule - numFormatAndVersionInfoModule) / 8;
            return dataCapacity;
        }
        ...
        internal virtual void decodeFormatInformation(bool[] formatInformation)
        {
            if (formatInformation[4] == false)
                if (formatInformation[3] == true)
                    _errorCollectionLevel = 0;
                else
                    _errorCollectionLevel = 1;
            else if (formatInformation[3] == true)
                _errorCollectionLevel = 2;
            else
                _errorCollectionLevel = 3;
        ...
        {
            _moduleMatrix[x][y] = !_moduleMatrix[x][y];
        }
